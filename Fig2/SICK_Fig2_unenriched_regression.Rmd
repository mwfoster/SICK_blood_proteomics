---
title: "SICK_Fig2: Unenriched_regression"
author: "M. Foster"
...
#plot results for Clus/crp for FigS2

```{r}
# Specify the Accession and dependent variable for regression
accession <- "CLUS_HUMAN"  # Example Accession
dependent_variable <- "crp"  # Example dependent variable

# Extract the row corresponding to the specified Accession
independent_var <- aligned_unenriched[aligned_unenriched$Accession == accession, ]

# Match sample IDs from "aligned_unenriched" with "Subject.ID" in "prospective_data"
...
# Save the plot as a PNG file
ggsave("FigS2_Clus_crp_regression.png", plot = plot, width = 4, height = 3, dpi = 300)
```

#plot results for Clus/uvascore for FigS2
...
# Save the plot as a PNG file
ggsave("FigS2_Clus_uvascore_regression.png", plot = plot, width = 4, height = 3, dpi = 300)
