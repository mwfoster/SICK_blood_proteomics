...
## CRP (Z-scored, Outliers Removed)

```{r crp-z-plot}
plot_zscored_protein("CRP_HUMAN", save_path = "CRP_plot.png", 
                     y_label = "CRP\n (Z-score)")
```
...
```{r saa1-z-plot}
plot_zscored_protein("SAA1_HUMAN", save_path = "SAA1_plot.png", 
                     y_label = "SAA1 (Z-score)")
```

## KAIN

```{r kain-z-plot}
plot_zscored_protein("KAIN_HUMAN", save_path = "KAIN_plot.png", 
                     y_label = "KAIN (Z-score)")
```

## TTHY

```{r tthy-z-plot}
plot_zscored_protein("TTHY_HUMAN", save_path = "TTHY_plot.png", 
                     y_label = "TTHY (Z-score)")
```

##MMP8

```{r mmp8-z-plot}
plot_zscored_protein("MMP8_HUMAN", save_path = "MMP8_plot.png",
                     y_label = "MMP8 (Z-score)")
...
```{r catg-z-plot}
plot_zscored_protein("CATG_HUMAN", save_path = "CATG_plot.png",
                     y_label = "CATG (Z-score)")
```
