...
```{r}
# List all CSV files in the working directory that start with "regression_results_"
...
accession <- "PON1_N324_H(6)N(5)S(2)F(2)"  # Example Accession
...
plot <- ggplot(matched_data, aes(x = Dependent, y = Independent)) +
  ...
  coord_cartesian(xlim = c(0, 200)) +  # zoom in range
  labs(
...
```{r}
# Specify the Accession and dependent variable for regression
accession <- "CLUS_N354_H(6)N(5)S(2)F(2)"  # Example Accession
