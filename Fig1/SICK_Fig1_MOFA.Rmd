...
# Apply the abbreviation function to the dataset
glyco_data$ProcessedFeature <- sapply(glyco_data$Feature, abbreviate_feature_name)

# Reorder the data to place the largest absolute weight at the top
glyco_data <- glyco_data[order(abs(glyco_data$Weight), decreasing = TRUE), ]

# Create the Glycopeptide plot
